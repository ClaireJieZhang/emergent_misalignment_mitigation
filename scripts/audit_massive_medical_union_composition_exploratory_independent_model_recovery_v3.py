#!/usr/bin/env python3
"""Fail-closed auditor for the one-shot independent-model smoke recovery.
...
SCHEMA_VERSION = 1
WORKFLOW_ID = (
    "massive_medical_union_composition_exploratory_workflow_independent_model_recovery_v3"
)
PROTOCOL_ID = (
    "massive_medical_union_composition_exploratory_protocol_independent_model_recovery_v3"
)
...
DIRECT_PARENT_COMMIT = "5e1bb439d60410f6e6ba853a0dae80625a72f9d3"
DIRECT_PARENT_TREE = "56dd4835cabe51ff6484abf0730d8ce309aabdb5"
PROBE_RECOVERY_V1_COMMIT = "8b5f8db2d54b6fc7da3d54c1cb024e950201d879"
PROBE_RECOVERY_V1_TREE = "41c142e2cfedb9b0e32fae529143029d702d72f3"
PROBE_RECOVERY_V1_WORKFLOW_ID = (
    "massive_medical_union_composition_exploratory_workflow_smoke_recovery_v1"
)
PROBE_RECOVERY_V1_JOB_ID = "261327"
PROBE_RECOVERY_V2_WORKFLOW_ID = (
    "massive_medical_union_composition_exploratory_workflow_smoke_probe_recovery_v2"
)
PROBE_RECOVERY_V2_JOB_ID = "261839"
PROBE_RECOVERY_V2_COMMIT = DIRECT_PARENT_COMMIT
PROBE_RECOVERY_V2_TREE = DIRECT_PARENT_TREE
BRANCH = (
...
PROBE_RECOVERY_V1_REPO = (
    TILLICUM_ROOT
    / "projects/subliminal-mitigate-mmu-composition-exploratory-smoke-recovery-v1"
)
PROBE_RECOVERY_V2_REPO = (
    TILLICUM_ROOT
    / "projects/subliminal-mitigate-mmu-composition-exploratory-smoke-probe-recovery-v2"
)
REPO_ROOT = (
    TILLICUM_ROOT
    / "projects/subliminal-mitigate-mmu-composition-exploratory-independent-model-recovery-v3"
)
SOURCE_OUTPUT = (
...
PROBE_RECOVERY_V1_OUTPUT = (
    TILLICUM_ROOT
    / "outputs/massive_medical_union_composition_exploratory_smoke_recovery_v1"
)
PROBE_RECOVERY_V1_CONTROL_ROOT = PROBE_RECOVERY_V1_OUTPUT / "control"
PROBE_RECOVERY_V1_GENERATION_ROOT = PROBE_RECOVERY_V1_OUTPUT / "generation"
PROBE_RECOVERY_V1_EVALUATION_ROOT = PROBE_RECOVERY_V1_OUTPUT / "evaluation"
PROBE_RECOVERY_V2_OUTPUT = (
    TILLICUM_ROOT
    / "outputs/massive_medical_union_composition_exploratory_smoke_probe_recovery_v2"
)
PROBE_RECOVERY_V2_CONTROL_ROOT = PROBE_RECOVERY_V2_OUTPUT / "control"
PROBE_RECOVERY_V2_GENERATION_ROOT = PROBE_RECOVERY_V2_OUTPUT / "generation"
PROBE_RECOVERY_V2_EVALUATION_ROOT = PROBE_RECOVERY_V2_OUTPUT / "evaluation"
OUTPUT_ROOT = (
    TILLICUM_ROOT
    / "outputs/massive_medical_union_composition_exploratory_independent_model_recovery_v3"
)
...
PREFLIGHT_FILE = CONTROL_ROOT / "INDEPENDENT_MODEL_RECOVERY_CPU_PREFLIGHT.json"
STAGED_FILE = CONTROL_ROOT / "STAGED"
LOCK_ROOT = CONTROL_ROOT / "INDEPENDENT_MODEL_RECOVERY_SUBMISSION_LOCK"
ATTEMPT_FILE = CONTROL_ROOT / "INDEPENDENT_MODEL_RECOVERY_SUBMISSION_ATTEMPT.tsv"
JOB_FILE = CONTROL_ROOT / "INDEPENDENT_MODEL_RECOVERY_JOB.json"
AUTH_FILE = CONTROL_ROOT / "INDEPENDENT_MODEL_RECOVERY_AUTHORIZED_MAX_COST_USD_0.225.json"
SUBMITTED_FILE = CONTROL_ROOT / "INDEPENDENT_MODEL_RECOVERY_SUBMITTED"
RELEASE_FILE = CONTROL_ROOT / "INDEPENDENT_MODEL_RECOVERY_RELEASE_AUTHORIZED"
RESULT_FILE = CONTROL_ROOT / "INDEPENDENT_MODEL_RECOVERY_RESULT.json"
STOP_FILE = CONTROL_ROOT / "STOPPED_independent_model_recovery"
...
JOB_NAME = "mmu_cmpx_ind_rec_v3"
LOG_PREFIX = "massive_medical_union_composition_exploratory_independent_model_recovery_v3"
RATE_PER_H200_MINUTE_USD = 0.015
ORIGINAL_ACTUAL_SECONDS = 35
ORIGINAL_ACTUAL_H200_MINUTES = ORIGINAL_ACTUAL_SECONDS / 60.0
ORIGINAL_ACTUAL_COST_USD = 0.00875
PROBE_RECOVERY_V1_ACTUAL_SECONDS = 71
PROBE_RECOVERY_V1_ACTUAL_H200_MINUTES = PROBE_RECOVERY_V1_ACTUAL_SECONDS / 60.0
PROBE_RECOVERY_V1_ACTUAL_COST_USD = 0.01775
PROBE_RECOVERY_V2_ACTUAL_SECONDS = 76
PROBE_RECOVERY_V2_ACTUAL_H200_MINUTES = PROBE_RECOVERY_V2_ACTUAL_SECONDS / 60.0
PROBE_RECOVERY_V2_ACTUAL_COST_USD = 0.01900
PRIOR_ACTUAL_SECONDS = (
    ORIGINAL_ACTUAL_SECONDS
    + PROBE_RECOVERY_V1_ACTUAL_SECONDS
    + PROBE_RECOVERY_V2_ACTUAL_SECONDS
)
PRIOR_ACTUAL_H200_MINUTES = PRIOR_ACTUAL_SECONDS / 60.0
PRIOR_ACTUAL_COST_USD = (
    ORIGINAL_ACTUAL_COST_USD
    + PROBE_RECOVERY_V1_ACTUAL_COST_USD
    + PROBE_RECOVERY_V2_ACTUAL_COST_USD
)
RECOVERY_CAP_MINUTES = 15
RECOVERY_CAP_COST_USD = 0.225
ACTUAL_PLUS_RECOVERY_CAP_COST_USD = 0.27050
...
FROZEN_MODIFIED_FILE_SHA256 = {
    "scripts/sample_massive_medical_union_composition_exploratory_v1.py": (
        "cb8b6a7e5eccca0c30bc3dfca3c84c01e80eb337ea40bf1876449bda650e8237"
    ),
    "scripts/summarize_massive_medical_union_composition_exploratory_v1.py": (
        "7846ce7ff674e16d7bbfa7517852d52a7d87ebd3e4636dc0b6f695c1767a4c83"
    ),
    "scripts/judge_massive_medical_union_composition_exploratory_v1.py": (
        "691cc44e742c50c302ede3ff4fa82f5e34ccea24523cb7d006d2f0b9c19c7b57"
    ),
    "tests/test_massive_medical_union_composition_exploratory_sampler.py": (
        "0957ebacaf7e887e0f660deda64a1f9beba7558c270dd4fad3b177c4cbc273c6"
    ),
    "tests/test_massive_medical_union_composition_exploratory_evaluation.py": (
        "e39e5cb7a12b8d54192570bcdc3867c8f11d32c4919ce6ccb9224133485b6921"
    ),
}
ADDED_FILES = (
...
PROBE_RECOVERY_V1_CONTROL_FILES = {
    "PREP.json": (23582, "2e517aace78fdd2443211a82d8519127e32ab612d32782e7d256ddbaa98b0f10"),
    "SMOKE_RECOVERY_AUTHORIZED_MAX_COST_USD_0.225.json": (
        29243, "8b000c37517faa4e9d391f1aa6d72bfdbe8af5c96faf3a5ccad3ed42008ba9a0"
    ),
    "SMOKE_RECOVERY_CPU_PREFLIGHT.json": (
        2597, "5207a26d1ec15d7d1eed692d8293abeb423468027c1fa8a365fa18a13dea5e79"
    ),
    "SMOKE_RECOVERY_JOB.json": (
        3791, "5d8acaffd3d815d6c786699c2eee2910858c49b58e1b1946323eb7c02e2e6d2a"
    ),
    "SMOKE_RECOVERY_RELEASE_AUTHORIZED": (
        82, "c166af175b11522762259d355e0841b900a1a35b2f830c8b1aba0cdc613cbff3"
    ),
    "SMOKE_RECOVERY_SUBMISSION_ATTEMPT.tsv": (
        35, "29bdeb2a63a396672668f2806d33cea14de529f11c877e6dd837c321fc246db4"
    ),
    "SMOKE_RECOVERY_SUBMISSION_LOCK/owner": (
        218, "ad8aa0fb7c83732e52313af703f16f552761d7ee7e4c52ab1d5173e7a3a1f943"
    ),
    "SMOKE_RECOVERY_SUBMITTED": (
        89, "c1cf585e28c9a03f67b4f969b37a5ffea2285a2ea0f82fee5721cf9d129e8b17"
    ),
    "STAGED": (555, "8478db70d2a925d68ada16c5fd455b3a77ac66cb6df43bfdb59cec628344d091"),
    "STOPPED_smoke_recovery": (
        205, "1da389771424e0ec92fa1b6a5411eb1604a6b1588adf044562ebfb48b3446915"
    ),
}
PROBE_RECOVERY_V1_GENERATION_FILES = {
    "smoke/.sampler.lock": (
        0, "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"
    ),
    "smoke/run_manifest.json": (
        832, "22e67bacbad9bc16b953d52d713b694194a352e6964540162fa37f5cd796b978"
    ),
}
PROBE_RECOVERY_V1_LOG_FILES = {
    "massive_medical_union_composition_exploratory_smoke_recovery_v1_261327.out": (
        155, "f4388967fcc74804b5c37a94206b97eb0f60c48b62826a8fc3d6fa02c8e3e974"
    ),
    "massive_medical_union_composition_exploratory_smoke_recovery_v1_261327.err": (
        3388, "212a4a861e04c41b967480ebb1796504f3238773cd225d3f243608f3c81a0848"
    ),
}

PROBE_RECOVERY_V2_CONTROL_FILES = {
    "PREP.json": (
        32169, "e92a3a23b0355eaed6eefaaa5116d1fdb6023529b26bc27257b4c8ad97b06c60"
    ),
    "SMOKE_PROBE_RECOVERY_AUTHORIZED_MAX_COST_USD_0.225.json": (
        40450, "9b69c4a715affd111af1b56b9ddfa93a61d6ace169f7e0f4f58247148365eb15"
    ),
    "SMOKE_PROBE_RECOVERY_CPU_PREFLIGHT.json": (
        4869, "f7ee476f35036d06efabbf7d67287b78d35cf0da1ebe7aff7462361d6f6a982e"
    ),
    "SMOKE_PROBE_RECOVERY_JOB.json": (
        3875, "baa559487692d8d60fd20eeaf367cfb73c37edf888f2ca6a1a6ecc11fe4f46b5"
    ),
    "SMOKE_PROBE_RECOVERY_RELEASE_AUTHORIZED": (
        88, "a2f028df15587e6d381e0bd4b3069e39759f06dde4ce5de0ebb7bdca71bedb0a"
    ),
    "SMOKE_PROBE_RECOVERY_SUBMISSION_ATTEMPT.tsv": (
        41, "7429df8418ed8e340b24cd10d07621e2fc6eb2b76e837661ad833c4f9afdeeb2"
    ),
    "SMOKE_PROBE_RECOVERY_SUBMISSION_LOCK/owner": (
        305, "6c6ffe8e18f6fe7bb3e03c89ea63874557a79f6a4ad543f2d308a8b3defc6701"
    ),
    "SMOKE_PROBE_RECOVERY_SUBMITTED": (
        95, "ad07b50e4f029e8fa1d84130e4459bf95174eb52863ffba4677191ee9a40bff1"
    ),
    "STAGED": (
        950, "aa7d755fe3db5546ef3aaeb79c7d8abed979cc353d1baea600080f3ca8a34142"
    ),
    "STOPPED_smoke_probe_recovery": (
        217, "8ab5eeb790f9364b4b06479155b6e458d4dc5f1c8613113fbb844faa2eb2d9e5"
    ),
}
PROBE_RECOVERY_V2_GENERATION_FILES = {
    "smoke/.sampler.lock": (
        0, "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"
    ),
    "smoke/run_manifest.json": (
...
PROBE_RECOVERY_V2_LOG_FILES = {
    "massive_medical_union_composition_exploratory_smoke_probe_recovery_v2_261839.out": (
        161, "0dfbece66b6e686ed2e445ff077d86afe37e203f503dde1478c4b276ed5b82f8"
    ),
    "massive_medical_union_composition_exploratory_smoke_probe_recovery_v2_261839.err": (
        3402, "b4fbd3dc1aaab65cb487a96c21ef7677726e0c0524b665e6d49e14f673e9e1e5"
    ),
}
...
def audit_repository():
    ...
    for relative in (*MODIFIED_FILES, *ADDED_FILES):
        ...
        if (
            relative in FROZEN_MODIFIED_FILE_SHA256
            and digest != FROZEN_MODIFIED_FILE_SHA256[relative]
        ):
            raise ValueError(f"recovery frozen modified bytes differ for {relative}")
        files[relative] = {
...
def exact_matching_log_inventory(pattern, expected_names, description):
    """Reject every unsafe or unexpected object matching a frozen log prefix."""
    observed = set()
    for path in LOG_ROOT.glob(pattern):
        if path.is_symlink() or not path.is_file():
            raise ValueError(f"{description} contains an unsafe object: {path}")
        if path.name in observed:
            raise ValueError(f"{description} contains a duplicate name: {path.name}")
...
def exact_tree_inventory(root, expected_files, expected_directories, description):
    """Require an exact regular-file/directory tree with no links or special files."""
    root = Path(root)
    if root.is_symlink() or not root.is_dir():
        raise ValueError(f"{description} root is missing or unsafe")
    files = set()
    ...
    if files != set(expected_files) or directories != set(expected_directories):
        raise ValueError(
            f"{description} inventory differs: "
            f"files={sorted(files)!r}, directories={sorted(directories)!r}"
        )
    file_bindings = {}
...
def source_sacct():
    ...
    return {
        ...
        "job_name": name,
        "state": state,
        "elapsed_seconds": ORIGINAL_ACTUAL_SECONDS,
        "actual_h200_minutes": ORIGINAL_ACTUAL_H200_MINUTES,
        "actual_gpu_cost_usd": ORIGINAL_ACTUAL_COST_USD,
        "exit_code": exit_code,
        "node": node,
        "sacct_row": line,
...
def probe_recovery_v1_sacct():
    output = subprocess.check_output(
        [
            "sacct", "-n", "-X", "-P", "-j", PROBE_RECOVERY_V1_JOB_ID,
            "--format=JobIDRaw,JobName,State,Elapsed,Timelimit,AllocTRES,ReqTRES,ExitCode,NodeList",
        ],
        text=True,
    )
    ...
    for line in output.strip().splitlines():
        fields = line.split("|")
        if fields and fields[0] == PROBE_RECOVERY_V1_JOB_ID:
            matches.append((line, fields))
    if len(matches) != 1 or len(matches[0][1]) < 9:
        raise ValueError("probe-recovery-v1 incident lacks unique durable accounting")
    line, fields = matches[0]
    _, name, state, elapsed, limit, allocated, requested, exit_code, node = fields[:9]
    if (
        name != "mmu_cmpx_smoke_rec_v1"
        or state != "FAILED"
        or elapsed != "00:01:11"
        or limit != "00:15:00"
        or exit_code != "1:0"
        ...
        raise ValueError("probe-recovery-v1 durable accounting differs")
    return {
        "job_id": PROBE_RECOVERY_V1_JOB_ID,
        "job_name": name,
        "state": state,
        "elapsed_seconds": PROBE_RECOVERY_V1_ACTUAL_SECONDS,
        "actual_h200_minutes": PROBE_RECOVERY_V1_ACTUAL_H200_MINUTES,
        "actual_gpu_cost_usd": PROBE_RECOVERY_V1_ACTUAL_COST_USD,
        "exit_code": exit_code,
        "node": node,
        "sacct_row": line,
        "sacct_row_sha256": sha256_bytes(line.encode("utf-8")),
...
def probe_recovery_v2_sacct():
    output = subprocess.check_output(
        [
            "sacct", "-n", "-X", "-P", "-j", PROBE_RECOVERY_V2_JOB_ID,
            "--format=JobIDRaw,JobName,State,Elapsed,Timelimit,AllocTRES,ReqTRES,ExitCode,NodeList",
        ],
        text=True,
    )
    ...
    for line in output.strip().splitlines():
        fields = line.split("|")
        if fields and fields[0] == PROBE_RECOVERY_V2_JOB_ID:
            matches.append((line, fields))
    if len(matches) != 1 or len(matches[0][1]) < 9:
        raise ValueError("probe-recovery-v2 incident lacks unique durable accounting")
    line, fields = matches[0]
    _, name, state, elapsed, limit, allocated, requested, exit_code, node = fields[:9]
    if (
        name != "mmu_cmpx_probe_rec_v2"
        or state != "FAILED"
        or elapsed != "00:01:16"
        or limit != "00:15:00"
        or exit_code != "1:0"
        ...
        raise ValueError("probe-recovery-v2 durable accounting differs")
    return {
        "job_id": PROBE_RECOVERY_V2_JOB_ID,
        "job_name": name,
        "state": state,
        "elapsed_seconds": PROBE_RECOVERY_V2_ACTUAL_SECONDS,
        "actual_h200_minutes": PROBE_RECOVERY_V2_ACTUAL_H200_MINUTES,
        "actual_gpu_cost_usd": PROBE_RECOVERY_V2_ACTUAL_COST_USD,
        "exit_code": exit_code,
        "node": node,
        "sacct_row": line,
        "sacct_row_sha256": sha256_bytes(line.encode("utf-8")),
...
def audit_source_protocol():
    if SOURCE_PROTOCOL_ROOT.is_symlink() or not SOURCE_PROTOCOL_ROOT.is_dir():
        raise ValueError("source protocol root is missing or unsafe")
...
def audit_source_incident():
    if (
        SOURCE_OUTPUT.is_symlink()
        or not SOURCE_OUTPUT.is_dir()
...
def audit_probe_recovery_v1_incident():
    if (
        PROBE_RECOVERY_V1_OUTPUT.is_symlink()
        or not PROBE_RECOVERY_V1_OUTPUT.is_dir()
        or PROBE_RECOVERY_V1_REPO.is_symlink()
        or not PROBE_RECOVERY_V1_REPO.is_dir()
        or git(PROBE_RECOVERY_V1_REPO, "rev-parse", "HEAD")
        != PROBE_RECOVERY_V1_COMMIT
        or git(PROBE_RECOVERY_V1_REPO, "rev-parse", "HEAD^{tree}")
        != PROBE_RECOVERY_V1_TREE
        or git(PROBE_RECOVERY_V1_REPO, "branch", "--show-current")
        != "claire/capability-quorum-secure-code-composition-exploratory-smoke-recovery-v1"
        or git(PROBE_RECOVERY_V1_REPO, "status", "--porcelain")
    ):
        raise ValueError("probe-recovery-v1 incident checkout differs")
    control = exact_file_inventory(
        PROBE_RECOVERY_V1_CONTROL_ROOT,
        PROBE_RECOVERY_V1_CONTROL_FILES,
        "probe-recovery-v1 control",
    )
    generation = exact_file_inventory(
        PROBE_RECOVERY_V1_GENERATION_ROOT,
        PROBE_RECOVERY_V1_GENERATION_FILES,
        "probe-recovery-v1 generation",
    )
    if os.path.lexists(PROBE_RECOVERY_V1_EVALUATION_ROOT):
        raise ValueError("probe-recovery-v1 unexpectedly has evaluation")
    source_preflight = load_json(
        PROBE_RECOVERY_V1_CONTROL_ROOT / "SMOKE_RECOVERY_CPU_PREFLIGHT.json",
        "probe-recovery-v1 CPU preflight",
    )
    if source_preflight.get("schema_sha256") != MASSIVE_SCHEMA_SHA256:
        raise ValueError("probe-recovery-v1 MASSIVE schema hash differs")
    logs = {}
    for name, (size, digest) in PROBE_RECOVERY_V1_LOG_FILES.items():
        path = require_regular(LOG_ROOT / name, f"probe-recovery-v1 log {name}")
        if path.stat().st_size != size or sha256_file(path) != digest:
            raise ValueError(f"probe-recovery-v1 log differs: {name}")
        logs[name] = binding(path)
    exact_matching_log_inventory(
        "massive_medical_union_composition_exploratory_smoke_recovery_v1_*",
        PROBE_RECOVERY_V1_LOG_FILES,
        "probe-recovery-v1 log",
    )
    stop = (PROBE_RECOVERY_V1_CONTROL_ROOT / "STOPPED_smoke_recovery").read_bytes()
    expected_stop = (
        b"workflow_id=massive_medical_union_composition_exploratory_workflow_smoke_recovery_v1\n"
        b"stage=smoke_recovery\njob_id=261327\nexit_code=1\n"
        b"retry_authorized=false\nconfirmation_submitted=false\n"
        b"external_api_calls=0\n"
    )
    if stop != expected_stop:
        raise ValueError("probe-recovery-v1 STOP record differs")
    run_path = PROBE_RECOVERY_V1_GENERATION_ROOT / "smoke/run_manifest.json"
    run_payload = load_json(run_path, "probe-recovery-v1 run manifest")
    run_body = verify_seal(run_payload, "probe-recovery-v1 run manifest")
    if (
        run_payload.get("payload_sha256")
        != "36d66f1a88b5e320ded8d4e80559b994eeacf436a72cada92ff1747b8f80cae4"
        or run_body.get("phase") != "smoke"
        ...
        raise ValueError("probe-recovery-v1 partial run manifest differs")
    stderr = (
        LOG_ROOT
        / "massive_medical_union_composition_exploratory_smoke_recovery_v1_261327.err"
    ).read_text(encoding="utf-8")
    exact_blocker = (
        "ValueError: cache-equivalence next logits mismatch for A: "
        "{'allclose': False, 'max_abs_diff': 0.25, "
        "'max_scaled_error': 222.2424774169922}"
    )
    if exact_blocker not in stderr or "Loading checkpoint shards: 100%" not in stderr:
        raise ValueError("probe-recovery-v1 exact terminal blocker differs")
    forbidden = (
        "SMOKE_RECOVERY_RESULT.json",
        "CONFIRMATION_JOB.json",
        "CONFIRMATION_RESULT.json",
        "FINAL_RESULT.json",
        "EXTERNAL_JUDGE_AUTHORIZED_MAX_COST_USD_0.75.json",
    ...
    if any(
        os.path.lexists(PROBE_RECOVERY_V1_CONTROL_ROOT / name)
        for name in forbidden
    ):
        raise ValueError("probe-recovery-v1 unexpectedly continued downstream")
    return {
        "workflow_id": PROBE_RECOVERY_V1_WORKFLOW_ID,
        "commit": PROBE_RECOVERY_V1_COMMIT,
        "tree": PROBE_RECOVERY_V1_TREE,
        "job_accounting": probe_recovery_v1_sacct(),
        "control_inventory": control,
        "generation_inventory": generation,
        "evaluation_namespace_absent": True,
        "logs": logs,
        "stop": control["STOPPED_smoke_recovery"],
        "partial_run_manifest": binding(run_path, run_payload),
        "massive_schema_sha256": MASSIVE_SCHEMA_SHA256,
        "base_checkpoint_all_four_shards_loaded": True,
        "exact_terminal_blocker": exact_blocker,
        "scientific_generations_completed": 0,
        "confirmation_submitted": False,
...
def audit_probe_recovery_v2_incident():
    if (
        PROBE_RECOVERY_V2_OUTPUT.is_symlink()
        or not PROBE_RECOVERY_V2_OUTPUT.is_dir()
        or PROBE_RECOVERY_V2_REPO.is_symlink()
        or not PROBE_RECOVERY_V2_REPO.is_dir()
        or git(PROBE_RECOVERY_V2_REPO, "rev-parse", "HEAD")
        != PROBE_RECOVERY_V2_COMMIT
        or git(PROBE_RECOVERY_V2_REPO, "rev-parse", "HEAD^{tree}")
        != PROBE_RECOVERY_V2_TREE
        or git(PROBE_RECOVERY_V2_REPO, "branch", "--show-current")
        != "claire/capability-quorum-secure-code-composition-exploratory-smoke-probe-recovery-v2"
        or git(PROBE_RECOVERY_V2_REPO, "status", "--porcelain")
    ):
        raise ValueError("probe-recovery-v2 incident checkout differs")
    control = exact_file_inventory(
        PROBE_RECOVERY_V2_CONTROL_ROOT,
        PROBE_RECOVERY_V2_CONTROL_FILES,
        "probe-recovery-v2 control",
    )
    generation = exact_file_inventory(
        PROBE_RECOVERY_V2_GENERATION_ROOT,
        PROBE_RECOVERY_V2_GENERATION_FILES,
        "probe-recovery-v2 generation",
    )
    if os.path.lexists(PROBE_RECOVERY_V2_EVALUATION_ROOT):
        raise ValueError("probe-recovery-v2 unexpectedly has evaluation")
    preflight = load_json(
        PROBE_RECOVERY_V2_CONTROL_ROOT / "SMOKE_PROBE_RECOVERY_CPU_PREFLIGHT.json",
        "probe-recovery-v2 CPU preflight",
    )
    if (
        preflight.get("schema_sha256") != MASSIVE_SCHEMA_SHA256
        or preflight.get("cache_equivalence_probe_contract", {}).get("protocol")
        != "massive_medical_union_composition_cache_equivalence_probe_v2"
        or preflight.get("cache_equivalence_probe_contract", {}).get(
            "contract_sha256"
        ) != "4756d50d1ee76e545486bb761ee32a3d7095530300efa42afe9f1b900a1bef17"
    ):
        raise ValueError("probe-recovery-v2 CPU preflight differs")
    logs = {}
    for name, (size, digest) in PROBE_RECOVERY_V2_LOG_FILES.items():
        path = require_regular(LOG_ROOT / name, f"probe-recovery-v2 log {name}")
        if path.stat().st_size != size or sha256_file(path) != digest:
            raise ValueError(f"probe-recovery-v2 log differs: {name}")
        logs[name] = binding(path)
    exact_matching_log_inventory(
        "massive_medical_union_composition_exploratory_smoke_probe_recovery_v2_*",
        PROBE_RECOVERY_V2_LOG_FILES,
        "probe-recovery-v2 log",
    )
    stop_path = PROBE_RECOVERY_V2_CONTROL_ROOT / "STOPPED_smoke_probe_recovery"
    expected_stop = (
        b"workflow_id=massive_medical_union_composition_exploratory_workflow_smoke_probe_recovery_v2\n"
        b"stage=smoke_probe_recovery\njob_id=261839\nexit_code=1\n"
        b"retry_authorized=false\nconfirmation_submitted=false\n"
        b"external_api_calls=0\n"
    )
    if stop_path.read_bytes() != expected_stop:
        raise ValueError("probe-recovery-v2 STOP record differs")
    run_path = PROBE_RECOVERY_V2_GENERATION_ROOT / "smoke/run_manifest.json"
    run_payload = load_json(run_path, "probe-recovery-v2 run manifest")
    run_body = verify_seal(run_payload, "probe-recovery-v2 run manifest")
    if (
        run_payload.get("payload_sha256")
        != "36d66f1a88b5e320ded8d4e80559b994eeacf436a72cada92ff1747b8f80cae4"
        or run_body.get("phase") != "smoke"
        ...
        raise ValueError("probe-recovery-v2 partial run manifest differs")
    stderr = (
        LOG_ROOT
        / "massive_medical_union_composition_exploratory_smoke_probe_recovery_v2_261839.err"
    ).read_text(encoding="utf-8")
    ...
    if exact_blocker not in stderr or "Loading checkpoint shards: 100%" not in stderr:
        raise ValueError("probe-recovery-v2 exact terminal blocker differs")
    forbidden = (
        "SMOKE_PROBE_RECOVERY_RESULT.json",
        "CONFIRMATION_JOB.json",
        "CONFIRMATION_RESULT.json",
        "FINAL_RESULT.json",
        "EXTERNAL_JUDGE_AUTHORIZED_MAX_COST_USD_0.75.json",
    ...
    if any(
        os.path.lexists(PROBE_RECOVERY_V2_CONTROL_ROOT / name)
        for name in forbidden
    ):
        raise ValueError("probe-recovery-v2 unexpectedly continued downstream")
    return {
        "workflow_id": PROBE_RECOVERY_V2_WORKFLOW_ID,
        "commit": PROBE_RECOVERY_V2_COMMIT,
        "tree": PROBE_RECOVERY_V2_TREE,
        "job_accounting": probe_recovery_v2_sacct(),
        "control_inventory": control,
        "generation_inventory": generation,
        "evaluation_namespace_absent": True,
        "logs": logs,
...
def audit_local_weight_resolver(snapshot=None):
    ...
    body = {
        "protocol": (
            ...
            "local_snapshot_resolver_independent_model_recovery_v3"
        ),
...
def expected_namespaces():
    return {
        ...
        "probe_recovery_v1_repository": os.fspath(PROBE_RECOVERY_V1_REPO),
        "probe_recovery_v1_output": os.fspath(PROBE_RECOVERY_V1_OUTPUT),
        "probe_recovery_v2_repository": os.fspath(PROBE_RECOVERY_V2_REPO),
        "probe_recovery_v2_output": os.fspath(PROBE_RECOVERY_V2_OUTPUT),
...
def budget_registry():
    return {
        "original_failed_actual_seconds": ORIGINAL_ACTUAL_SECONDS,
        "original_failed_actual_h200_minutes": ORIGINAL_ACTUAL_H200_MINUTES,
        "original_failed_actual_gpu_cost_usd": ORIGINAL_ACTUAL_COST_USD,
        "probe_recovery_v1_failed_actual_seconds": PROBE_RECOVERY_V1_ACTUAL_SECONDS,
        "probe_recovery_v1_failed_actual_h200_minutes": (
            PROBE_RECOVERY_V1_ACTUAL_H200_MINUTES
        ),
        "probe_recovery_v1_failed_actual_gpu_cost_usd": (
            PROBE_RECOVERY_V1_ACTUAL_COST_USD
        ),
        "probe_recovery_v2_failed_actual_seconds": PROBE_RECOVERY_V2_ACTUAL_SECONDS,
        "probe_recovery_v2_failed_actual_h200_minutes": (
            PROBE_RECOVERY_V2_ACTUAL_H200_MINUTES
        ),
        "probe_recovery_v2_failed_actual_gpu_cost_usd": (
            PROBE_RECOVERY_V2_ACTUAL_COST_USD
        ),
        "prior_failed_actual_seconds": PRIOR_ACTUAL_SECONDS,
        "prior_failed_actual_h200_minutes": PRIOR_ACTUAL_H200_MINUTES,
        "prior_failed_actual_gpu_cost_usd": PRIOR_ACTUAL_COST_USD,
        "independent_model_recovery_v3_h200_minutes_max": RECOVERY_CAP_MINUTES,
        "independent_model_recovery_v3_gpu_cost_usd_max": RECOVERY_CAP_COST_USD,
        "prior_actual_plus_independent_model_recovery_v3_cap_h200_minutes": (
            PRIOR_ACTUAL_H200_MINUTES + RECOVERY_CAP_MINUTES
        ),
        "prior_actual_plus_independent_model_recovery_v3_cap_gpu_cost_usd": (
...
def prep_body(created_at=None):
    ...
    return {
        ...
        "probe_recovery_v1_incident": audit_probe_recovery_v1_incident(),
        "probe_recovery_v2_incident": audit_probe_recovery_v2_incident(),
        "environment": {
        ...
        "probe_recovery_v1_incident_immutable": True,
        "probe_recovery_v2_incident_immutable": True,
...
def expected_probe_v3_static_contract():
    top_level_keys = {
    ...
    body = {
        ...
        "diagnostic_policy": {
            ...
            "legacy_allclose_atol": 0.001,
            "legacy_allclose_rtol": 0.001,
        ...
        "gpu_memory_contract": {
            "production_device": "cuda:0",
            "model_object_count": 5,
            "indexed_weight_bytes_per_model": 15231233024,
            "total_indexed_weight_bytes": 76156165120,
            "minimum_total_memory_bytes": 128849018880,
            "minimum_free_memory_bytes_before_probe": 34359738368,
            "minimum_free_memory_bytes_after_probe": 34359738368,
            "formula": (
    ...
    if digest != PROBE_V3_STATIC_CONTRACT_SHA256:
        raise ValueError("locally frozen probe-v3 static contract hash differs")
    return {**body, "contract_sha256": digest}


def audit_probe_v3_static_contract(value):
    if value != expected_probe_v3_static_contract():
        raise ValueError("sampler cache-equivalence probe-v3 static contract differs")
    return value
...
def load_preflight():
    ...
    if payload.get("schema_sha256") != MASSIVE_SCHEMA_SHA256:
    ...
    audit_probe_v3_static_contract(payload.get("cache_equivalence_probe_contract"))
    expected_keys = {
        *expected_scalar,
        "runtime",
        "schema_sha256",
...
def staged_bytes(prep, preflight):
    return (
        f"workflow_id={WORKFLOW_ID}\n"
        f"protocol_id={PROTOCOL_ID}\n"
        f"repo_commit={prep['repository']['commit']}\n"
        f"cpu_preflight_file_sha256={preflight['file_sha256']}\n"
        f"direct_parent_commit={DIRECT_PARENT_COMMIT}\n"
        f"original_source_commit={SOURCE_COMMIT}\n"
        f"original_source_job_id={SOURCE_JOB_ID}\n"
        "original_source_stop_preserved=true\n"
        f"probe_recovery_v1_commit={PROBE_RECOVERY_V1_COMMIT}\n"
        f"probe_recovery_v1_job_id={PROBE_RECOVERY_V1_JOB_ID}\n"
        "probe_recovery_v1_stop_preserved=true\n"
        f"probe_recovery_v2_commit={PROBE_RECOVERY_V2_COMMIT}\n"
        f"probe_recovery_v2_job_id={PROBE_RECOVERY_V2_JOB_ID}\n"
        "probe_recovery_v2_stop_preserved=true\n"
        "stage_submitted_jobs=0\n"
        "prior_failed_actual_gpu_cost_usd=0.04550\n"
        "independent_model_recovery_v3_gpu_h200_minutes_max=15\n"
        "independent_model_recovery_v3_gpu_cost_usd_max=0.225\n"
        "prior_actual_plus_independent_model_recovery_v3_cap_gpu_cost_usd=0.27050\n"
        "training=false\n"
        "external_api_calls=0\n"
        "recovery_confirmation_submission_code_present=false\n"
    ).encode("utf-8")
...
def audit_staged():
    ...
    if staged.read_bytes() != staged_bytes(prep, preflight):
...
def command_write_staged(_args):
    ...
    atomic_write_once(STAGED_FILE, staged_bytes(prep, preflight))
...
def command_assert_submit_ready(_args):
    audit_staged()
    expected = {"PREP.json", "INDEPENDENT_MODEL_RECOVERY_CPU_PREFLIGHT.json", "STAGED"}
    observed = set()
...
def lock_owner_bytes(commit):
    return (
        ...
        f"probe_recovery_v1_job_id={PROBE_RECOVERY_V1_JOB_ID}\n"
        f"probe_recovery_v2_job_id={PROBE_RECOVERY_V2_JOB_ID}\n"
        "prior_actual_gpu_cost_usd=0.04550\n"
        "new_versioned_recovery_not_retry=true\n"
    ).encode("utf-8")


def require_private_control_mode(path, description):
    if path.stat().st_mode & 0o777 != 0o400:
        raise ValueError(f"{description} mode differs")


def lock_binding(expected_commit=None):
    ...
    commit = expected_commit or git(REPO_ROOT, "rev-parse", "HEAD")
    if owner.read_bytes() != lock_owner_bytes(commit):
        raise ValueError("recovery lock owner differs")
    require_private_control_mode(owner, "recovery lock owner")
...
def parse_attempt(job_id):
    ...
    expected = f"stage\tjob_id\nindependent_model_recovery\t{job_id}\n".encode("utf-8")
    if path.read_bytes() != expected:
        raise ValueError("recovery submission attempt differs")
    require_private_control_mode(path, "recovery submission attempt")
    return binding(path)


def submitted_bytes(job_id):
    return (
        "stage=independent_model_recovery\n"
        f"job_id={job_id}\n"
        "held_first=true\n"
...
def submitted_binding(job_id):
    path = require_regular(SUBMITTED_FILE, "recovery submitted marker")
    if path.read_bytes() != submitted_bytes(job_id):
        raise ValueError("recovery submitted marker differs")
    require_private_control_mode(path, "recovery submitted marker")
    return binding(path)


def audit_submission_records(job_id, expected_commit=None):
    return {
        "permanent_submission_lock": lock_binding(expected_commit),
        "submission_attempt": parse_attempt(job_id),
        "submitted": submitted_binding(job_id),
    }


def release_bytes(job_id):
    return (
        f"stage=independent_model_recovery\njob_id={job_id}\nheld_audit_passed=true\n"
...
def command_write_held_auth(args):
    ...
    if (
        ...
        or probe_recovery_v1_incident
        != prep.get("probe_recovery_v1_incident")
        or probe_recovery_v2_incident
        != prep.get("probe_recovery_v2_incident")
    ):
    ...
    job_body = {
        ...
        "held_audit": held,
        "submission_attempt": parse_attempt(job_id),
        "permanent_submission_lock": lock_binding(repository["commit"]),
    }
    ...
    auth_body = {
        ...
        "pre_release_probe_recovery_v1_incident": probe_recovery_v1_incident,
        "pre_release_probe_recovery_v2_incident": probe_recovery_v2_incident,
...
def job_pointer():
    ...
    if (
        ...
        or body.get("workflow_id") != WORKFLOW_ID
        or body.get("stage") != "independent_model_recovery"
...
def auth_pointer():
    ...
    expected_keys = {
        ...
        "pre_release_source_incident", "pre_release_probe_recovery_v1_incident",
        "pre_release_probe_recovery_v2_incident",
        "pre_release_local_model_snapshot",
        "pre_release_local_weight_resolver", "pre_release_runtime_versions",
        "pre_release_offline_cache_environment", "prior_failed_actual_seconds",
        "prior_failed_actual_h200_minutes", "prior_failed_actual_gpu_cost_usd",
    ...
    if (
        ...
        or body.get("pre_release_probe_recovery_v1_incident")
        != prep.get("probe_recovery_v1_incident")
        or body.get("pre_release_probe_recovery_v2_incident")
        != prep.get("probe_recovery_v2_incident")
...
def audit_current_authorized_provenance(auth):
    ...
    if (
        audit_probe_recovery_v1_incident()
        != auth["pre_release_probe_recovery_v1_incident"]
    ):
        raise ValueError("immutable probe-recovery-v1 incident drifted after authorization")
    if (
        audit_probe_recovery_v2_incident()
        != auth["pre_release_probe_recovery_v2_incident"]
    ):
        raise ValueError("immutable probe-recovery-v2 incident drifted after authorization")
    snapshot = audit_local_model_snapshot()
...
def expected_recovery_control_inventory(phase):
    expected = {
        "PREP.json",
        "INDEPENDENT_MODEL_RECOVERY_CPU_PREFLIGHT.json",
        "STAGED",
        "INDEPENDENT_MODEL_RECOVERY_SUBMISSION_LOCK/owner",
        "INDEPENDENT_MODEL_RECOVERY_SUBMISSION_ATTEMPT.tsv",
        "INDEPENDENT_MODEL_RECOVERY_JOB.json",
        "INDEPENDENT_MODEL_RECOVERY_AUTHORIZED_MAX_COST_USD_0.225.json",
        "INDEPENDENT_MODEL_RECOVERY_SUBMITTED",
    }
    if phase in ("running", "result", "stopped"):
        expected.add("INDEPENDENT_MODEL_RECOVERY_RELEASE_AUTHORIZED")
    if phase == "result":
        expected.add("INDEPENDENT_MODEL_RECOVERY_RESULT.json")
    elif phase == "stopped":
        expected.add("STOPPED_independent_model_recovery")
    elif phase not in ("held", "running"):
        raise ValueError("unknown recovery control phase")
    return expected


def recovery_control_inventory(phase):
    expected = expected_recovery_control_inventory(phase)
    observed = set()
    for path in CONTROL_ROOT.rglob("*"):
        if path.is_symlink():
...
def audit_recovery_log_inventory(phase, job_id):
    expected_logs = (
        set()
        if phase == "held"
        else {f"{LOG_PREFIX}_{job_id}.out", f"{LOG_PREFIX}_{job_id}.err"}
    )
    if phase not in ("held", "running", "result", "stopped"):
        raise ValueError("unknown recovery log phase")
    return exact_matching_log_inventory(
        f"{LOG_PREFIX}_*", expected_logs, f"recovery {phase} log"
    )
...
def audit_scientific_namespace_fresh(phase, job_id):
    ...
    audit_recovery_log_inventory(phase, job_id)
...
def command_audit_held(args):
    ...
    audit_submission_records(args.job_id, auth["pre_release_repository"]["commit"])
...
def command_verify_job(args):
    ...
    print("INDEPENDENT_MODEL_RECOVERY_RUNNING_AUDIT_OK")
...
def audit_stream_manifest_for_inventory(method_id):
    relative = f"smoke/{method_id}/massive/stream_manifest.json"
    path = GENERATION_ROOT / relative
    payload = load_json(path, f"recovery {method_id} stream manifest")
    body = verify_seal(payload, f"recovery {method_id} stream manifest")
    if (
        set(body) != {"schema_version", "protocol", "meta", "sample_specs"}
        or body.get("schema_version") != 1
        or body.get("protocol")
        != "massive_medical_union_composition_exploratory_generation_v1"
        or not isinstance(body.get("meta"), dict)
        or body["meta"].get("phase") != "smoke"
        or body["meta"].get("domain") != "MASSIVE"
        or body["meta"].get("method_id") != method_id
        or not isinstance(body.get("sample_specs"), list)
        or len(body["sample_specs"]) != 60
    ):
        raise ValueError(f"recovery {method_id} stream manifest differs")
    shard_names = []
    for ordinal, spec in enumerate(body["sample_specs"]):
        if (
            not isinstance(spec, dict)
            or set(spec)
            != {
                "ordinal", "question_id", "sample_index", "prompt_sha256",
                "shard_name",
            }
            or spec.get("ordinal") != ordinal
            or spec.get("sample_index") != 0
            or not isinstance(spec.get("question_id"), str)
            or not spec["question_id"]
            or re.fullmatch(r"[0-9a-f]{64}", spec.get("prompt_sha256", ""))
            is None
        ):
            raise ValueError(f"recovery {method_id} sample specification differs")
        expected_name = (
            f"sample-{ordinal:06d}-"
            f"{hashlib.sha256(spec['question_id'].encode('utf-8')).hexdigest()[:16]}"
            "-n000.json"
        )
        if spec.get("shard_name") != expected_name:
            raise ValueError(f"recovery {method_id} shard name differs")
        shard_names.append(expected_name)
    if len(set(shard_names)) != 60:
        raise ValueError(f"recovery {method_id} shard names are not unique")
    return shard_names


def audit_post_generation_science_inventory():
    """Seal the exact smoke-only tree and reject confirmation or extra artifacts."""
    load_run_manifest()
    gate = load_gate()
    methods = (
        "pi_base",
    ...
    generation_files = {
        "smoke/.sampler.lock",
        "smoke/run_manifest.json",
        "smoke/setup_timing.json",
        "smoke/timings.json",
    }
    generation_directories = {"smoke"}
    for method_id in methods:
        stream = f"smoke/{method_id}/massive"
        generation_directories.update(
            {f"smoke/{method_id}", stream, f"{stream}/shards"}
        )
        generation_files.update(
            {f"{stream}/stream_manifest.json", f"{stream}/generation.json"}
        )
        generation_files.update(
            f"{stream}/shards/{name}"
            for name in audit_stream_manifest_for_inventory(method_id)
        )
    generation = exact_tree_inventory(
        GENERATION_ROOT,
        generation_files,
        generation_directories,
        "recovery post-generation namespace",
    )
    sentinel = gate["status"]
    evaluation_files = {
        *(f"smoke/scores/{method_id}.json" for method_id in methods),
        "smoke/gate/runtime_projection.json",
        "smoke/gate/summary.json",
        f"smoke/gate/{sentinel}",
    }
    evaluation = exact_tree_inventory(
        EVALUATION_ROOT,
        evaluation_files,
        {"smoke", "smoke/scores", "smoke/gate"},
        "recovery post-evaluation namespace",
    )
    return {"generation": generation, "evaluation": evaluation}
...
def result_body(job_id, created_at=None):
    ...
    submission_records = audit_submission_records(
        job_id, auth["pre_release_repository"]["commit"]
    )
    control_inventory_before_result_seal = recovery_control_inventory("running")
    audit_recovery_log_inventory("result", job_id)
    post_generation_science_inventory = audit_post_generation_science_inventory()
    ...
    probe_recovery_v1 = auth["pre_release_probe_recovery_v1_incident"]
    probe_recovery_v2 = auth["pre_release_probe_recovery_v2_incident"]
    return {
        "schema_version": SCHEMA_VERSION,
        "workflow_id": WORKFLOW_ID,
        "protocol_id": PROTOCOL_ID,
        ...
        "control_inventory_before_result_seal": (
            control_inventory_before_result_seal
        ),
        "post_generation_science_inventory": post_generation_science_inventory,
        "gate": gate,
        "scientific_status": gate["status"],
        "source_incident_after_recovery": source,
        "source_incident_unchanged": True,
        "probe_recovery_v1_incident_after_recovery": probe_recovery_v1,
        "probe_recovery_v1_incident_unchanged": True,
        "probe_recovery_v2_incident_after_recovery": probe_recovery_v2,
        "probe_recovery_v2_incident_unchanged": True,
        "prior_failed_actual_gpu_cost_usd": PRIOR_ACTUAL_COST_USD,
...
def audit_result():
    ...
    gate = load_gate()
    submission_records = audit_submission_records(
        auth["job_id"], auth["pre_release_repository"]["commit"]
    )
    recovery_control_inventory("result")
    audit_recovery_log_inventory("result", auth["job_id"])
    post_generation_science_inventory = audit_post_generation_science_inventory()
    expected_keys = {
        "schema_version", "workflow_id", "protocol_id", "created_at", "stage",
        "job_id", "job", "authorization", "running_job_audit", "cpu_preflight",
        "generation_run_manifest", "submission_records",
        "control_inventory_before_result_seal",
        "post_generation_science_inventory", "gate", "scientific_status",
        "source_incident_after_recovery", "source_incident_unchanged",
        "probe_recovery_v1_incident_after_recovery",
        "probe_recovery_v1_incident_unchanged",
        "probe_recovery_v2_incident_after_recovery",
        "probe_recovery_v2_incident_unchanged",
        "prior_failed_actual_gpu_cost_usd", "recovery_released_gpu_cost_usd_cap",
        "prior_actual_plus_independent_model_recovery_v3_cap_gpu_cost_usd",
    ...
    expected_values = {
        ...
        "generation_run_manifest": load_run_manifest(),
        "submission_records": submission_records,
        "control_inventory_before_result_seal": sorted(
            expected_recovery_control_inventory("running")
        ),
        "post_generation_science_inventory": post_generation_science_inventory,
        "gate": gate,
        "scientific_status": gate["status"],
    ...
    if (
        body["probe_recovery_v1_incident_after_recovery"]
        != auth["pre_release_probe_recovery_v1_incident"]
    ):
        raise ValueError("probe-recovery-v1 incident changed before result")
    if (
        body["probe_recovery_v2_incident_after_recovery"]
        != auth["pre_release_probe_recovery_v2_incident"]
    ):
        raise ValueError("probe-recovery-v2 incident changed before result")
    return {**body, "payload_sha256": payload["payload_sha256"]}
...
def terminal_accounting():
    ...
    return {
        ...
        "prior_failed_actual_gpu_cost_usd": PRIOR_ACTUAL_COST_USD,
        "prior_actual_plus_independent_model_recovery_v3_actual_gpu_cost_usd": (
...
def stopped_terminal_accounting():
    job = job_pointer()
    output = subprocess.check_output(
        [
            "sacct", "-n", "-X", "-P", "-j", job["job_id"],
    ...
    for line in output.strip().splitlines():
        ...
        if fields and fields[0] == job["job_id"]:
            matches.append((line, fields))
    if len(matches) != 1 or len(matches[0][1]) < 8:
        raise ValueError("stopped recovery job lacks unique durable accounting")
    line, fields = matches[0]
    _, name, state, elapsed, limit, allocated, requested, exit_code = fields[:8]
    terminal_state = state.split()[0].rstrip("+")
    allowed = {
    ...
    if (
        name != JOB_NAME
        or terminal_state not in allowed
        or limit != "00:15:00"
        or exit_code == "0:0"
        ...
        raise ValueError("stopped recovery durable accounting differs")
    seconds = parse_duration(elapsed)
    if not 0 < seconds <= RECOVERY_CAP_MINUTES * 60:
        raise ValueError("stopped recovery elapsed time exceeds cap")
    return {
        "job_id": job["job_id"],
        "job_name": JOB_NAME,
        "state": state,
        "exit_code": exit_code,
        "elapsed_seconds": seconds,
        "actual_h200_minutes": seconds / 60.0,
        "actual_gpu_cost_usd": seconds / 60.0 * RATE_PER_H200_MINUTE_USD,
        "sacct_row": line,
        "sacct_row_sha256": sha256_bytes(line.encode("utf-8")),
    }


def audit_partial_smoke_only_namespaces():
    """Reject non-smoke, linked, or special scientific state after a failed job."""
    observed = {}
    for label, root in (("generation", GENERATION_ROOT), ("evaluation", EVALUATION_ROOT)):
        if not os.path.lexists(root):
            observed[label] = None
            continue
        if root.is_symlink() or not root.is_dir():
            raise ValueError(f"stopped recovery {label} root is unsafe")
        entries = list(root.iterdir())
        if any(path.name != "smoke" for path in entries):
            raise ValueError(f"stopped recovery {label} contains non-smoke state")
        files = {}
        directories = []
        for path in root.rglob("*"):
            relative = os.fspath(path.relative_to(root))
            forbidden_parts = {"confirmation", "medical", "judge", "training", "api"}
            if any(part.lower() in forbidden_parts for part in path.relative_to(root).parts):
                raise ValueError(
                    f"stopped recovery {label} contains forbidden downstream state"
                )
            if path.is_symlink():
                raise ValueError(f"stopped recovery {label} contains a symlink")
            if path.is_file():
                files[relative] = {
                    "size_bytes": path.stat().st_size,
                    "file_sha256": sha256_file(path),
                ...
                raise ValueError(f"stopped recovery {label} contains an unsafe object")
        observed[label] = {
...
def command_audit_stopped_terminal(_args):
    auth = auth_pointer()
    accounting = stopped_terminal_accounting()
    if accounting["job_id"] != auth["job_id"]:
        raise ValueError("stopped recovery accounting job differs")
    exit_status = accounting["exit_code"].split(":", 1)[0]
    expected_stop = (
        f"workflow_id={WORKFLOW_ID}\n"
        "stage=independent_model_recovery\n"
        f"job_id={auth['job_id']}\n"
        f"exit_code={exit_status}\n"
        "retry_authorized=false\n"
        "confirmation_submitted=false\n"
        "external_api_calls=0\n"
    ).encode("utf-8")
    stop = require_regular(STOP_FILE, "stopped recovery sentinel")
    if stop.read_bytes() != expected_stop:
        raise ValueError("stopped recovery sentinel differs")
    require_private_control_mode(stop, "stopped recovery sentinel")
    recovery_control_inventory("stopped")
    audit_recovery_log_inventory("stopped", auth["job_id"])
    science = audit_partial_smoke_only_namespaces()
    audit_current_authorized_provenance(auth)
    print(
        json.dumps(
            {
                "status": "RECOVERY_STOPPED_TERMINAL_AUDIT_OK",
                "accounting": accounting,
                "stop": binding(stop),
                "partial_smoke_only_science": science,
                "confirmation_submitted": False,
                "external_api_calls": 0,
            },
            sort_keys=True,
...
def build_parser():
    ...
    commands.add_parser("audit-stopped-terminal").set_defaults(
        function=command_audit_stopped_terminal
    )
    return parser
