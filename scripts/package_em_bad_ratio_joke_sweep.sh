...
for bad_count in $COUNTS; do
  ...
  files+=( "$ratio_rel/narrow_medical64_s${SAMPLE_N}_a100_1gpu"/metrics_joke_on_narrow64_ratio.* )
...
files+=( "majority_bad_medical_union_4bad_1good/narrow_medical64_joke_5way_s${SAMPLE_N}_a100_1gpu"/metrics_joke_on_narrow64_with_5way.* )
