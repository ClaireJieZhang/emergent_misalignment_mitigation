...
for bad_count in $COUNTS; do
  ...
  files+=( "$ratio_rel/narrow_medical64_s${NARROW64_SAMPLE_N}_a100_1gpu"/metrics_medical64_*_ratio.* )
  files+=( "$ratio_rel/narrow_medical64_s${NARROW64_SAMPLE_N}_a100_1gpu"/metrics_joke_on_narrow64_ratio.* )
  ...
  files+=( "$ratio_rel/eval64_s${SAMPLE_N}_a100_1gpu"/metrics_joke_on_broad_ratio.* )
done
...
files+=( "majority_bad_medical_union_4bad_1good/narrow_medical64_joke_5way_s${NARROW64_SAMPLE_N}_a100_1gpu"/metrics_medical64_*_ratio.* )
files+=( "majority_bad_medical_union_4bad_1good/narrow_medical64_joke_5way_s${NARROW64_SAMPLE_N}_a100_1gpu"/metrics_joke_on_narrow64_with_5way.* )
