...
| Kalai et al. (s=3) (context) | 314/360 accepted (87.22%); 314/360 requested (87.22%); 100.00% coverage | not pre-specified | 1/78 accepted (1.28%); 3/80 BAD+abstain (3.75%); 97.50% coverage | descriptive only | 78/78 | 0/78 | 0/78 | Context only; not gated |
